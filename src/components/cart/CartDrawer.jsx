          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {cart.length === 0 ? (
              ...
              cart.map((item, index) => {
                ...
                // Directly parse your original image source without fallback loops
                const image = 
                  item.image || 
                  item.product?.image || 
                  item.product?.imageUrl || 
                  (Array.isArray(item.product?.images) && (item.product.images[0]?.url || item.product.images[0])) ||
                  '';
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3">
                      {image ? (
                        ...
                        <div className="w-14 h-14 flex items-center justify-center bg-gray-200 rounded-md text-[10px] text-gray-500 shrink-0 text-center px-1">
                          No Image
                        </div>
                      )}
                      <div>
